...
namespace io::dns
{
	inline auto resolve(std::string_view protocol, std::string_view host) -> io::coro<boost::asio::ip::tcp::resolver::results_type>
	{
		static io::service<boost::asio::ip::tcp::resolver> service;
